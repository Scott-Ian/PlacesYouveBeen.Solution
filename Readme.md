...
| :-------------     | :-------------     | :------------- | :------------- |:------------- |
|1.|The program can instantiate a Place object of type Place | N/A | N/A | _False_|
|2.|Place objects have a cityName parameter which can be retrieved | N/A  | N/A |_False_|
